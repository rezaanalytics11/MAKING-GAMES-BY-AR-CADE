...
class GameView(arcade.View):
    ...
    def on_update(self, delta_time):
        ...
        if self.frame_count % 5 == 0:
                ...
                # Position the coin
                self.stone.center_x = SCREEN_WIDTH + (50* random.randrange(SCREEN_WIDTH))
                #self.stone.center_y = 150
                self.stone.center_y = random.randint(100, 150)
                self.stone_sprite_list.append(self.stone)
                self.stone.change_x -= random.randint(3,10)
